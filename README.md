...
Асоціація з класами:
   ...
   ─ 	Адміністратор може працювати з користувачами, тому він має асоціацію з класом User.
   
   ─ 	Також адміністратор відповідає за керуванням промокодами, тому він має асоціацію з класом Promotion.
 
Реалізація інтерфейсу:

Реалізує інтерфейс IAdmin, який містить методи для аутентифікації, додавання, редагування та видалення промокодів.
...
Взаємодіє з класом Admin для перегляду акцій та промокодів.
...
Так само як і Guest, наслідує від класу PersonBase.
Взаємодія з іншими класами:
Взаємодіє з класом Admin для отримання списку дійсних промокодів та використання їх.
...
Використовується класами User та Guest через наслідування.
...
Реалізує інтерфейси IEnumerableExtensions<Promotion> та IComparableExtensions<Promotion>, що дозволяє промокодам бути перебираєми та порівнюваними.
 
Взаємодія з іншими класами:
...
Інтерфейс, який визначає методи, які повинен реалізувати адміністратор системи.

**IComparableExtensions:**

Використовується класом Promotion: Оголошує методи порівняння для об'єктів промокодів.

**IEnumerableExtensions:**

Використовується класом Promotion: Оголошує методи перелічення для об'єктів промокодів.
