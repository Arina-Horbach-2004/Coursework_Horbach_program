...
{
    partial class EditPromotionPage
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            активніToolStripMenuItem = new ToolStripMenuItem();
            ...
            // 
            файлToolStripMenuItem.DropDownItems.AddRange(new ToolStripItem[] { активніToolStripMenuItem, видаленіПромокодиToolStripMenuItem });
            файлToolStripMenuItem.Font = new Font("Times New Roman", 7.8F);
            файлToolStripMenuItem.Name = "файлToolStripMenuItem";
            файлToolStripMenuItem.Size = new Size(50, 20);
            файлToolStripMenuItem.Text = "Файл";
            // 
            // активніToolStripMenuItem
            // 
            активніToolStripMenuItem.DropDownItems.AddRange(new ToolStripItem[] { зберегтиToolStripMenuItem, завантажитиToolStripMenuItem });
            активніToolStripMenuItem.Name = "активніToolStripMenuItem";
            активніToolStripMenuItem.Size = new Size(202, 26);
            активніToolStripMenuItem.Text = " Активні промокоди";
            // 
            ...
            button_search.Location = new Point(320, 394);
            button_search.Name = "button_search";
            button_search.Size = new Size(130, 37);
            button_search.TabIndex = 64;
            ...
            button_save.Location = new Point(599, 335);
            button_save.Name = "button_save";
            button_save.Size = new Size(130, 64);
            button_save.TabIndex = 63;
            ...
            label_data.Location = new Point(40, 281);
            label_data.Name = "label_data";
            label_data.Size = new Size(174, 26);
            label_data.TabIndex = 53;
        ...
        private ToolStripMenuItem активніToolStripMenuItem; // Активні промокоди
        ...
        private Button button_log_exit; // Кнопка виходу або входу з системи
        ...
        private PictureBox pictureBox_photo; // Елемент для відображення зображення       
        private DateTimePicker dateTimePicker_data; // Елемент для вибору дати        
        private ComboBox comboBox_category; // Випадаючий список категорій       
        private TextBox textBox_description; // Текстове поле для опису        
        private TextBox textBox_promocode; // Текстове поле для промокоду        
        private TextBox textBox_shop; // Текстове поле для назви магазину
        private TextBox textBox_ID; // Текстове поле для ID
        private Label label_description; // Мітка для опису
        private Label label_data;  // Мітка для дати
        private Label label_promocode;  // Мітка для промокоду
        private Label label_category; // Мітка для категорії
        private Label label_shop; // Мітка для магазину
        private Label label_ID;   // Мітка для ID
    }
}